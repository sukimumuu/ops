...
<body class="m-0 bg-white font-sans text-secondary antialiased">
    ...
    <main>
            ...
            <div class="relative z-10 mx-auto w-full max-w-7xl px-4 py-28 sm:px-6 lg:py-36">
                ...
                <div class="max-w-4xl overflow-hidden rounded-2xl bg-white shadow-2xl">
                    ...
                    <div class="grid gap-3 p-4 sm:grid-cols-2 lg:grid-cols-[1.2fr_1fr_1fr_auto] lg:items-end">
                        ...
                        <button class="rounded-lg bg-primary px-6 py-3.5 text-sm font-bold text-white transition hover:bg-[#df3f05]"><span aria-hidden="true">⌕</span> Cari Properti</button>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="fade-in bg-gray-50 px-4 py-20 sm:px-6"><div class="mx-auto max-w-7xl"><div class="mb-8 flex flex-wrap items-end justify-between gap-4"><div><p class="mb-3 text-xs font-extrabold uppercase tracking-[0.2em] text-primary">Rekomendasi</p><h2 class="font-display text-3xl font-extrabold text-secondary sm:text-4xl">Properti Terbaik Untuk Anda</h2></div><a href="#" class="rounded-lg border-2 border-primary px-5 py-2.5 text-sm font-bold text-primary transition hover:bg-primary hover:text-white">Lihat Semua Properti</a></div><div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">

...
<body class="m-0 flex min-h-screen overflow-x-hidden bg-secondary font-sans text-white">
    ...
    <script>
        ...
        function togglePw(inputId, button) { const input = document.getElementById(inputId); const isText = input.type === 'text'; input.type = isText ? 'password' : 'text'; button.textContent = isText ? '👁' : '🙈'; }
